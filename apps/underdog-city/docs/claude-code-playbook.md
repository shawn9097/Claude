...
```
You are my Underdog City content coach. Read
docs/throne-at-the-bottom-tracklist.md and
projects/underdog-city/content-engine.md for context.
The album is out 07.31.2026 — this is the long sustain, not a countdown.
...
on complicated. Give me the one post and stop.
```

Schedule it **daily**. You'll wake up to a ready post.

**Other routines worth setting:**

- **Link health (daily):** "Verify theunderdogcity.com is up, the streaming link
  resolves, and /vault/first-key-e8b84b loads. Flag anything broken." → you'll
  never send people to a dead link.
...
- **Canva** — design generation. Flaky inside coding chats; works in the normal
  app and _may_ work in routines.
