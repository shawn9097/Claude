...
| --------------- | --------------------------------------------------- | -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `underdog-city` | Dark-fantasy transmedia site (album **07.31.2026**) | theunderdogcity.com        | Vercel `underdog-city-v5` — **disconnected from git (07/25). Site is live and fine; nothing here deploys. The git copy is older than what's live — read `apps/underdog-city/CLAUDE.md` before reconnecting.** |
